...
import com.example.mainactivity.fragments.CharactersFragment

class CaracterAdapter(
    private val characters: MutableList<Caracter>,
    private val listener: CharactersFragment
):RecyclerView.Adapter<CaracterAdapter.ViewHolder>() {
    interface PlaceListener {
        fun onPlaceClicked(data: Caracter, position: Int)
    }
    class ViewHolder(private val view: View, private val listener: CharactersFragment): RecyclerView.ViewHolder(view){
        ...
        private fun setListeners(character: Caracter){
