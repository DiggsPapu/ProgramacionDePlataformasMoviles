...
public final class CaracterDB_Impl extends CaracterDB {
  private volatile CaracterDao _caracterDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void dropAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("DROP TABLE IF EXISTS `Caracter`");
        if (mCallbacks != null) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        final TableInfo _existingCaracter = TableInfo.read(_db, "Caracter");
        if (! _infoCaracter.equals(_existingCaracter)) {
          return new RoomOpenHelper.ValidationResult(false, "Caracter(com.example.mainactivity.classes.Caracter).\n"
                  + " Expected:\n" + _infoCaracter + "\n"
                  + " Found:\n" + _existingCaracter);
        }
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "Caracter");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `Caracter`");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(CaracterDao.class, CaracterDao_Impl.getRequiredConverters());
  ...
  @Override
  public CaracterDao caracterDao() {
    if (_caracterDao != null) {
      return _caracterDao;
    } else {
      synchronized(this) {
        if(_caracterDao == null) {
          _caracterDao = new CaracterDao_Impl(this);
        }
        return _caracterDao;
      }
    }
